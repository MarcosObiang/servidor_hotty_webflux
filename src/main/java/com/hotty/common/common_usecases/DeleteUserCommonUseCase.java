...
public class DeleteUserCommonUseCase {
    ...
    private Mono<Void> deleteNonEssentialData(String userUID) {
            ...
            Mono<Void> transactionOperation = transactionsRepository.executeInTransaction(template -> {
            ...
            return retryHelper.executeWithRetry(
                    ...
                    "DeleteNonEssentialData_" + userUID
            );
    }
    ...
    private Mono<Void> performRollBack(String userUID, UserCachedData userCachedData) {
            ...
            Mono<Void> rollbackOperation = transactionsRepository.executeInTransaction(template -> {
